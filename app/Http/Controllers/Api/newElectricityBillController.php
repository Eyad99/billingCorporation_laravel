...
class newElectricityBillController extends Controller
{
    ...
    public function destroy($hour_number, $course_number, $receipt_id, $user_id)
    {
        ...
        archivedElectricityBill::create([
            ...
            'power' => $newElectricityBill->power,
            'previous_visa' => $newElectricityBill->previous_visa,
            'current_visa' => $newElectricityBill->current_visa,
            'amount_of_consumption' => $newElectricityBill->amount_of_consumption,
